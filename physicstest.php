...
if (isset($_POST["finishtest"])){
  mysqli_query($db,"INSERT INTO testscores (username,score,testname) VALUES ('".$_SESSION["username"]."',".$_POST["finalscore"].",'Physics Test')");
}
...
<div class="cleaner_with_height">&nbsp;</div>
<form action="physicstest.php" method="POST">
